...
def process_movielens1m(max_his_length=20):
    DIR = 'MovieLens1m/ml-1m/'
    try:
        data = pickle.load(open('processed_MovieLens1m.pkl', 'rb'))
    except:
        # # 电影排名
        ...
        cat_mapping = {}
        item_cat_mapping = {}
        total_num = sum([1 for line in open(DIR + 'movies.dat', 'r', encoding='ISO-8859-1')])
        with open(DIR + 'movies.dat', 'r', encoding='ISO-8859-1') as f_samp:
        ...
        pickle.dump(data, open('processed_MovieLens1m.pkl', "wb"))
