...
from alg_autocash import AutoCASH, MetaPredictor, MetaDataSet
...
parser.add_argument('--cluster_epoch', type=int, default=30,
                    help='how many epochs to do a clustering')
parser.add_argument('--ks_times', type=int, default=10,
                    help='rounds of doing clustering in k_means algorithm')
parser.add_argument('--use_attn', default='False', action='store_true',
                    help='whether use attention to lean the solution embeddings')
