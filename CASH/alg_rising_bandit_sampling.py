...
import random
import json
from cash_evaluation_sampling import CTREvaluation
...
class Bandit_Sampling(Random):
    def __init__(self, args):
        ...
        self.environment_setting(args, 'Bandit_Sampling')
        if args.device == -1:
            device_name = "cpu"
        else:
    ...
    def main(self):
        ...
        self.logger.info('Bandit_Sampling Search End ......')
