...
python main_new.py --search_method Bandit_Sampling --full_data_name AmazonElectronics --epochs 5 --device 0
python autodl_notice.py Electronics
python main_new.py --search_method Bandit_Sampling --full_data_name AmazonMovies_and_TV --epochs 5 --device 0
